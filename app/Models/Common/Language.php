...
class Language extends Model{
    ...
    public static function getTranslationByLang($code){
        ...
        $auth       = include(realpath(base_path('resources/lang') . "/$code/auth.php"));
        $interface  = include(realpath(base_path('resources/lang') . "/$code/interface.php"));
    ...
    public static function insertKey($data,$id,$file = "interface"){
