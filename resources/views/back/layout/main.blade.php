<!DOCTYPE html>
<html lang="en-us">
@include('back.layout.main_header')
<body class="">
        ...
        <ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
            <li class="">
                <a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown">
                    <img src="{{asset('/assets/back/img/avatars/sunny.png')}}" alt="John Doe" class="online"/>
                </a>
...
@include('back.layout.main_nav_left')
        <!-- END NAVIGATION -->
...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li> @yield('breadcrumb_first', '')</li>
            <li> @yield('breadcrumb_second', '')</li>
        </ol>
        <!-- end breadcrumb -->
...
<div class="page-footer">
    <div class="row">
        <div class="col-xs-12 col-sm-6">
            <span class="txt-color-white">SmartAdmin 1.8.0 <span class="hidden-xs"> - Web Application Framework</span> © 2014-2015</span>
        </div>
...
<!-- END PAGE FOOTER -->
<!--================================================== -->
@include('back.layout.main_scripts')
@yield('scripts', '')
</body>
</html>